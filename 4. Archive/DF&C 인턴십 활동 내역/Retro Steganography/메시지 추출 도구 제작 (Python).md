...
---
### 만들면서 헷갈렸던/어려웠던 것
1. XOR에 사용하는 키를 처음에는 16진수 음수표현으로 해야 하나 생각했는데, [[Python|Python]]에는 16진수 음수표현 대신 `bytes([10진수 숫자])` 이렇게 표현하고 음수는 `256 - (Java에서의 음수값)`으로 10진수로 나타내면 된다는 것을 이번 프로젝트를 통해 알 수 있었다.
