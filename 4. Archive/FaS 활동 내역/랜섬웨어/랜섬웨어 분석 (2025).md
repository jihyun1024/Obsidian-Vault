- [[#정적 분석 (Ghidra 사용)|정적 분석 (Ghidra 사용)]]
	- [[#정적 분석 (Ghidra 사용)#FUN_140001930 함수 분석|FUN_140001930 함수 분석]]
	- [[#정적 분석 (Ghidra 사용)#`FUN_140001bd0` 함수 분석|`FUN_140001bd0` 함수 분석]]
	- [[#정적 분석 (Ghidra 사용)#`FUN_140001320` 함수 분석|`FUN_140001320` 함수 분석]]
	- [[#정적 분석 (Ghidra 사용)#`FUN_140001740` 함수 분석|`FUN_140001740` 함수 분석]]
		- [[#`FUN_140001740` 함수 분석#`FUN_1400014b0` 함수 분석|`FUN_1400014b0` 함수 분석]]
		- [[#`FUN_140001740` 함수 분석#`FUN_140001000` 함수 분석|`FUN_140001000` 함수 분석]]
- [[#랜섬웨어가 실행되지 않는 조건|랜섬웨어가 실행되지 않는 조건]]
- [[#랜섬웨어 복호화|랜섬웨어 복호화]]
- [[#랜섬웨어 구조도|랜섬웨어 구조도]]
- [[#추가로 찾은 데이터|추가로 찾은 데이터]]
