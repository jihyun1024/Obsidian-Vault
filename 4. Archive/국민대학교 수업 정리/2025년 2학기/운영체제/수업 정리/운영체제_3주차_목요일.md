...
소켓은 여러 종류가 있으며, 연결형 프로토콜인 TCP, 비연결형 프로토콜인 IP, 다수의 수신자가 있는 Multicast 등으로 구분할 수 있다. [[4. Archive/국민대학교 수업 정리/2025년 2학기/보안네트워크 프로그래밍/2주차 수업|TCP&IP 전송계층]] 수업 요약을 참고하자.
