...
- [[#Get IV length or Block length|Get IV length or Block length]]
- [[#Calculate Cipher/Plain Size|Calculate Cipher/Plain Size]]
- [[#Close Algorithm Provider|Close Algorithm Provider]]
- [[#더 간결하게 실행할 수 있는 방법|더 간결하게 실행할 수 있는 방법]]
