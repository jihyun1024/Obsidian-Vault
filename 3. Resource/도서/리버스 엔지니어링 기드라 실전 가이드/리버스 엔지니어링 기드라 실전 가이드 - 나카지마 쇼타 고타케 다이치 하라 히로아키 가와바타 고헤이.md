...
# 부록
[[부록(리버스 엔지니어링 기드라 실전 가이드)|기초 편, 실전 편에서 다루지 않았던 기드라 응용 기능과 더불어 리버스 엔지니어링에 도움이 되는 Ghidra Script 소개, 한국어판 특별 부록으로 CTF 형식의 문제를 실제로 풀어볼 수 있는 부록 추가]] 

![[Pasted image 20250822192130.png]]
...
또는 실제 리눅스 환경이나 가상 머신을 준비해 이용해도 상관없다. 
