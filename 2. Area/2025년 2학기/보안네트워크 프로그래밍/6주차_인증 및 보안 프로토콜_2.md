...
---
## 강의 요약
이번 시간에는 저번 [[5주차_인증 및 보안 프로토콜|5주차 수업]]에서 다룬 내용을 복습하고, 다른 내용을 추가로 더 배운다. 
### OpenSSL 암호화 프로그래밍
**OpenSSL**에서 사용하는 EVP 라이브러리를 이용한 암호화 프로그래밍 중에서 [[5주차_인증 및 보안 프로토콜#예제 1 - 해시 함수|해시 함수]]를 이용한 프로그래밍과 [[5주차_인증 및 보안 프로토콜#예제 2 - HMAC 함수|HMAC]]을 이용한 프로그래밍은 이미 다뤘으니 넘어갈 것이다. 
